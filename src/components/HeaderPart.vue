...
<!--            <div class="leftPart_newText" onclick="document.querySelector('.week').scrollIntoView();" style="cursor: pointer">New</div>-->
        <div class="nav_tab" onclick="window.location.href = '/'" style="cursor: pointer">Home</div>
      ...
      <div class="rightPart" v-if="this.user.length !== 0">
        ...
        <div class="rightPart_cartsImg">
          <img :src="cart2Img" alt="cart" class="rightPart_cart2Img" onclick="window.location.href = '/siteCart'" style="cursor: pointer">
          <img :src="cartImg" alt="cart" class="rightPart_cartImg" onclick="window.location.href = '/siteCart'" style="cursor: pointer">
        </div>
        <img :src="logoutImg" alt="logout" class="rightPart_logoutImg" style="cursor: pointer" v-on:click="logout">
        <img :src="userImg" alt="user" class="rightPart_userImg" onclick="window.location.href = '/siteUser'" style="cursor: pointer">
      </div>

      <div class="rightPart" v-else>
        <img :src="loginImg" alt="login" class="rightPart_loginImg" onclick="window.location.href = '/login'" style="cursor: pointer">
        <img :src="registerImg" alt="register" class="rightPart_registerImg" onclick="window.location.href = '/register'" style="cursor: pointer">
      </div>
